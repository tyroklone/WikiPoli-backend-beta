...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/styles/search_result.css') }}"/>
        ...
        <div class="navbar-collapse collapse" id="navbar9">
            <ul id="main-navbar" class="navbar-nav ml-auto">
                <li class="navbar-item mr-5">
                    <a href="signup.html" class="btn navbar-link" id="signUp" style="background-color: #6d9bf1;"> Posts</a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="search">
    <p> Search results for "Lorem"</p>
    <form action="action_page.php">
        <input type="text" name="search" placeholder="Lorem" class="justify-content-right mr-auto">
...
<!--<script type="text/javascript" src="scripts/postpage1.js"></script>-->
