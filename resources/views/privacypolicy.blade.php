...
<body>
    ...
    <section class="policy">
        <div class="row d-sm-flex center border-top justify-content-center" >
            ...
            <h2 class="ml-sm-4 mt-sm-4">Privacy Policy</h2>
           </div>
      
           <div class="col-sm-9  mt-sm-4 content">  
            <p  class="mt-sm-4">Effective date: October 22, 2019</p>            
            
            <p>WikiPoli ("us", "we", or "our") operates the http://wikipoli.gq/ website (hereinafter referred to as the "Service").</p>
            
            <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. Our Privacy Policy  for WikiPoli is created with the help of the <a href="https://www.privacypolicies.com/free-privacy-policy-generator/">PrivacyPolicies.com Privacy Policy Generator</a>.</p>
            
            <p>We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, the terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible from http://wikipoli.gq/</p>          
            ...
            <ul class="list-styled ml-sm-4 session">
                <li>Session Cookies: We use Session Cookies to operate our Service.</li><br>
                <li>Preference Cookies: We use Preference Cookies to remember your preferences and various settings.</li><br>
                <li>Security Cookies: We use Security Cookies for security purposes.</li>
            </ul>
            
            <h5>Use of Data</h5>
                
            <p>WikiPoli uses the collected data for various purposes:</p>    
            <ul class="list-styled ml-sm-4">
            ...
            <p>WikiPoli will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
            
            <h5>Disclosure Of Data</h5>
            
            <h5>Legal Requirements</h5>
            <p>WikiPoli may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
            <ul class="list-styled ml-sm-4">
                <li>To comply with a legal obligation</li>
                <li>To protect and defend the rights or property of WikiPoli</li>
            ...
            <h5>Contact Us</h5>
            <p>If you have any questions about this Privacy Policy, please contact us:  By visiting this page on our website: http://wikipoli.gq/contact</p>           
